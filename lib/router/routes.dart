...
class AppRoutes {
  ...
  static List<String> get allRoutes => [
    ...
    profile, editProfile, settings, addresses, addAddress, editAddress,
    products, productDetail, productSearch, productsByCategory,
    categories, categoryDetail,
    cart, checkout, checkoutShipping, checkoutPayment, checkoutConfirmation,
    orders, orderDetail, orderTracking,
    favorites, wishlist,
    search, searchResults,
    support, contactUs, faq, helpCenter,
    notifications, notificationDetail,
    about, privacyPolicy, termsOfService,
    testCore, testLocalization, testRouting,
    notFound, error,
  ];
}
