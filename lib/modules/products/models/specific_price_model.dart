...
class SpecificPrice {
  ...
  factory SpecificPrice.fromPrestaShopJson(Map<String, dynamic> json) {
    return SpecificPrice(
      ...
      idProductAttribute: int.tryParse(
        json['id_product_attribute']?.toString() ?? '0',
      ),
      ...
      idSpecificPriceRule: int.tryParse(
        json['id_specific_price_rule']?.toString() ?? '0',
      ),
  ...
  Map<String, dynamic> toPrestaShopJson() {
    ...
    if (idProductAttribute != null)
      json['id_product_attribute'] = idProductAttribute.toString();
    if (idSpecificPriceRule != null)
      json['id_specific_price_rule'] = idSpecificPriceRule.toString();
  ...
  String toPrestaShopXml() {
    ...
    if (idSpecificPriceRule != null)
      buffer.writeln(
        '  <id_specific_price_rule><![CDATA[$idSpecificPriceRule]]></id_specific_price_rule>',
      );
