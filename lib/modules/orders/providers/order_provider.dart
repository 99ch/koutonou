...
import '../models/order_state_model.dart' as state_model;
import '../models/order_payment_model.dart';
import '../models/order_invoice_model.dart';
import '../models/order_history_model.dart';
import '../models/order_detail_model.dart' as detail_model;
...
import '../services/order_slip_service.dart';
import '../services/order_cart_rule_service.dart';
import '../services/order_carrier_service.dart';
...
class OrderProvider with ChangeNotifier {
  ...
  final OrderSlipService _orderSlipService = OrderSlipService();
  final OrderCartRuleService _orderCartRuleService = OrderCartRuleService();
  final OrderCarrierService _orderCarrierService = OrderCarrierService();
  ...
  // États de commande
  List<state_model.OrderState> _orderStates = [];
  ...
  List<detail_model.OrderDetail> _selectedOrderDetails = [];
  ...
  List<state_model.OrderState> get orderStates => _orderStates;
  ...
  List<detail_model.OrderDetail> get selectedOrderDetails =>
      _selectedOrderDetails;
  ...
  state_model.OrderState? getOrderStateById(int stateId) {
    try {
  ...
  /// Met à jour l'état d'une commande (alias pour changeOrderState)
  Future<bool> updateOrderState(
    int orderId,
    int newStateId, {
    int? employeeId,
  }) async {
    return await changeOrderState(orderId, newStateId, employeeId: employeeId);
  }
